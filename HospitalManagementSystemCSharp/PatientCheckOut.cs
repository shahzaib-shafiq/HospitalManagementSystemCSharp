    ...
    public partial class PatientCheckOut : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "")
            {
                try
                {
                    string getCust = "select name,gen,age,cont,addr,disease from patientinfo where id=" + Convert.ToInt32(textBox1.Text) + " ;";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string str = "INSERT INTO checkout(id,name,gen,age,contact,addr,disease,date_in,date_out,build,r_no,r_type,status,med_price,total) VALUES('" + textBox1.Text + "','" + textBox2.Text + "','" + gen + "','" + textBox3.Text + "','" + textBox5.Text + "','" + textBox6.Text + "','" + textBox7.Text + "','" + textBox8.Text + "','" + textBox9.Text + "','" + textBox10.Text + "','" + textBox11.Text + "','" + textBox12.Text + "','" + textBox14.Text + "','" + textBox13.Text + "','" + textBox15.Text + "'); ";
