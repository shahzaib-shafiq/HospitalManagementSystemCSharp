    ...
    public partial class PatientInformation : Form
    {
        ...
        private void PatientInformation_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con1 = new SqlConnection(@"Data Source=DESKTOP-A85V0ME\SQLEXPRESS;Initial Catalog=Hospitalmanagement;Integrated Security=True"))
            {
                ...
                string str2 = "SELECT * FROM patientinfo";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "")
            {
                try
                {
                    string getCust = "select id,name,gen,age,date,cont,addr,disease,status,r_type,building,r_no,price from patientinfo where id=" + Convert.ToInt32(textBox1.Text) + " ;";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string str = " Update patientinfo set name='" + textBox2.Text + "',gen='" + gen + "',age='" + textBox3.Text + "',date='" + textBox4.Text + "',cont='" + textBox5.Text + "',addr='" + textBox6.Text + "',disease='" + textBox7.Text + "',status='" + textBox8.Text  + "',r_type='" + textBox10.Text + "',building='" + textBox9.Text + "',r_no='" + textBox11.Text + "',price='" + textBox12.Text + "' where id='" + textBox1.Text + "'";

                SqlCommand cmd = new SqlCommand(str, con);
                cmd.ExecuteNonQuery();

                string str1 = "select max(id) from patientinfo;";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string str = "DELETE FROM patientinfo WHERE id = '" + textBox1.Text + "'";
