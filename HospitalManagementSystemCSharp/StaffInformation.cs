    ...
    public partial class StaffInformation : Form
    {
        ...
        private void StaffInformation_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con1 = new SqlConnection(@"Data Source=DESKTOP-A85V0ME\SQLEXPRESS;Initial Catalog=Hospitalmanagement;Integrated Security=True"))
            {
                ...
                string str2 = "SELECT * FROM stafinfo";
            ...
            con.Open();
            string str1 = "select max(id) from stafinfo;";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string str = "INSERT INTO stafinfo(id,name,gender,position,salary,contact,address) VALUES('" + textBox1.Text + "','"+ textBox2.Text + "','" + gen + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox6.Text + "','" + textBox7.Text + "'); ";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "")
            {
                try
                {
                    string getCust = "select name,gender,position,salary,contact,address from stafinfo where id=" + Convert.ToInt32(textBox1.Text) + " ;";
